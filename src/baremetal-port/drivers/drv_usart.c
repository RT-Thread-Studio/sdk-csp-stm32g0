...
#define UART_IS_RX        (0U)
   ...
   static const struct gpio_uart_af uart_afs[] =
      {
          { .pin_index = GET_PIN(A,  0), .afs[0] = {.uart_num = UART_IS_TX|4, .af_num = 4}},
          { .pin_index = GET_PIN(A,  1), .afs[0] = {.uart_num = UART_IS_RX|4, .af_num = 4}},
          { .pin_index = GET_PIN(A,  2), .afs[0] = {.uart_num = UART_IS_TX|2, .af_num = 1}},
          { .pin_index = GET_PIN(A,  3), .afs[0] = {.uart_num = UART_IS_RX|2, .af_num = 1}},
          { .pin_index = GET_PIN(A,  9), .afs[0] = {.uart_num = UART_IS_TX|1, .af_num = 1}},
          { .pin_index = GET_PIN(A, 10), .afs[0] = {.uart_num = UART_IS_RX|1, .af_num = 1}},
          { .pin_index = GET_PIN(A, 14), .afs[0] = {.uart_num = UART_IS_TX|2, .af_num = 1}},
          { .pin_index = GET_PIN(A, 15), .afs[0] = {.uart_num = UART_IS_RX|2, .af_num = 1}},
          { .pin_index = GET_PIN(B,  6), .afs[0] = {.uart_num = UART_IS_TX|1, .af_num = 0}},
          { .pin_index = GET_PIN(B,  7), .afs[0] = {.uart_num = UART_IS_RX|1, .af_num = 0}},
          { .pin_index = GET_PIN(B,  8), .afs[0] = {.uart_num = UART_IS_TX|3, .af_num = 4}},
          { .pin_index = GET_PIN(B,  9), .afs[0] = {.uart_num = UART_IS_RX|3, .af_num = 4}},
          { .pin_index = GET_PIN(B, 10), .afs[0] = {.uart_num = UART_IS_TX|3, .af_num = 4}},
          { .pin_index = GET_PIN(B, 11), .afs[0] = {.uart_num = UART_IS_RX|3, .af_num = 4}},
          { .pin_index = GET_PIN(C,  4), .afs[0] = {.uart_num = UART_IS_TX|3, .af_num = 0}},
          { .pin_index = GET_PIN(C,  5), .afs[0] = {.uart_num = UART_IS_RX|3, .af_num = 0}},
          { .pin_index = GET_PIN(C,  4), .afs[0] = {.uart_num = UART_IS_TX|1, .af_num = 1}},
          { .pin_index = GET_PIN(C,  5), .afs[0] = {.uart_num = UART_IS_RX|1, .af_num = 1}},
          { .pin_index = GET_PIN(C, 10), .afs[0] = {.uart_num = UART_IS_TX|3, .af_num = 0}},
          { .pin_index = GET_PIN(C, 11), .afs[0] = {.uart_num = UART_IS_RX|3, .af_num = 0}},
          { .pin_index = GET_PIN(C, 10), .afs[0] = {.uart_num = UART_IS_TX|4, .af_num = 1}},
          { .pin_index = GET_PIN(C, 11), .afs[0] = {.uart_num = UART_IS_RX|4, .af_num = 1}},
          { .pin_index = GET_PIN(D,  5), .afs[0] = {.uart_num = UART_IS_TX|2, .af_num = 0}},
          { .pin_index = GET_PIN(D,  6), .afs[0] = {.uart_num = UART_IS_RX|2, .af_num = 0}},
          { .pin_index = GET_PIN(D,  8), .afs[0] = {.uart_num = UART_IS_TX|3, .af_num = 0}},
          { .pin_index = GET_PIN(D,  9), .afs[0] = {.uart_num = UART_IS_RX|3, .af_num = 0}},
       };
